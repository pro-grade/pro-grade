...
public class ParsedPolicy {
    ...
    public ParsedPolicy(List<ParsedPolicyEntry> grantEntries, List<ParsedPolicyEntry> denyEntries, ParsedKeystoreEntry keystore, String keystorePasswordURL, File policyFile) {
        this(grantEntries,denyEntries,keystore,keystorePasswordURL,policyFile,false);
    }

    public ParsedPolicy(List<ParsedPolicyEntry> grantEntries, List<ParsedPolicyEntry> denyEntries, ParsedKeystoreEntry keystore, String keystorePasswordURL, File policyFile, boolean priority) {
